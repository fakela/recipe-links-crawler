...
chrome.get("https://www.thekitchn.com/search?filter=recipes&q=meatballs")
chrome.execute_script("window.scrollTo(0, document.body.scrollHeight);")
time.sleep(3)
save_cookies(chrome, cookies_location)

# #gets the different meatballs recipe name
elements = chrome.find_elements_by_css_selector(".Teaser__headline Teaser__link")
cardTitle = [el.text for el in elements]

# #gets the different meatballs recipe urls/links
linkUrls = chrome.find_elements_by_css_selector(".Teaser__headline Teaser__link")
